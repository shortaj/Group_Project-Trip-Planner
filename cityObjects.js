...
var cityObjects = [
  ...
  new City('London', 'United Kingdom', 'sightseeing', 'spring, winter', '$$$', 'solo, couple, family, pet', 'img/London.jpg'),
  ...
  new City('Seattle', 'Washington, USA', 'sightseeing, sports', 'summer, winter', '$$, $$$', 'solo, couple, pet', 'img/Seattle.jpg'),
  new City('San Diego', 'California, USA', 'beach, sports', 'fall, winter', '$', 'family, pet', 'img/SanDiego.jpg'),
  new City('New York', 'New York, USA', 'sightseeing', 'winter', '$, $$', 'single, family', 'img/NewYorkCity.jpg'),
  new City('Vancouver', 'BC, Canada', 'sightseeing', 'spring, winter', '$$', 'family, pet', 'img/Vancouver.jpg'),
  new City('Cancun', 'Mexico', 'beach', 'spring, summer', '$$', 'couple, family', 'img/Cancun.jpg'),
  new City('Burlington', 'Vermont, USA', 'sports', 'fall', '$$$', 'couple, family, pet' , 'img/Vermont.jpg'),
  new City('Rio De Janeiro', 'Brazil', 'beach', 'summer, winter', '$', 'single', 'img/RioDeJaneiro.jpg'),
  new City('Chichen Itza', 'Mexico', 'sightseeing', 'spring, winter', '$', 'family', 'img/ChichenItza.jpg'),
  new City('Lima', 'Peru', 'sightseeing', 'summer', '$', 'couple, family', 'img/LimaPeru.jpg'),
  new City('San Francisco', 'California, USA', 'sightseeing, beach', 'fall', '$$, $$$', 'couple, pet', 'img/SanFrancisco.jpg'),
  new City('Honolulu', 'Hawaii, USA', 'sightseeing, beach', 'winter', '$$$', 'couple', 'img/Honolulu.jpg'),
